...
INTERNAL_IP=$(nova list | grep worker-0 | awk '{print $12}' | cut -d'=' -f2- )
...
```
> If you assign public IP to worker-0|work-1|work-2, most probably you get a different value for INTERNAL_IP. verify it before you run the command
